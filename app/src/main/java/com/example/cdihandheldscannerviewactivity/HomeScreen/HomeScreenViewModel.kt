...
class HomeScreenViewModel : ViewModel(){
    ...
    class MenuOptions{
        companion object{
            ...
            val AssignExpirationMenuOption = MenuOptionDataClass("Assign Expiration", R.id.action_homeScreenFragment_to_assignExpirationDateFragment, "RfBtnAssignExpirationDate")
        }
    }
